...
PERMISSIONS: list[tuple[str, str]] = [
    ...
    # --- Phase 10: analytics & reporting (§26) ---------------------------------
    ("analytics.view", "View the global analytics dashboard (Phase 10)"),
    ("analytics.view_leads", "View lead analytics (Phase 10)"),
    ("analytics.view_scraping", "View scraper analytics (Phase 10)"),
    ("analytics.view_marketing", "View marketing analytics (Phase 10)"),
    ("analytics.view_whatsapp", "View WhatsApp analytics (Phase 10)"),
    ("analytics.view_email", "View email analytics (Phase 10)"),
    ("analytics.view_inbox", "View inbox/conversation analytics (Phase 10)"),
    ("analytics.view_team", "View team performance analytics (Phase 10)"),
    ("analytics.view_automation", "View automation analytics (Phase 10)"),
    ("analytics.manage", "Rebuild aggregates and run analytics diagnostics (Phase 10)"),
    ("reports.view", "View saved reports (Phase 10)"),
    ("reports.create", "Create saved reports (Phase 10)"),
    ("reports.edit", "Edit owned/managed reports (Phase 10)"),
    ("reports.delete", "Delete owned/managed reports (Phase 10)"),
    ("reports.run", "Execute saved reports (Phase 10)"),
    ("reports.export", "Export report results (Phase 10)"),
    ("reports.manage", "Manage all reports regardless of ownership (Phase 10)"),
...
ROLE_PERMISSIONS: dict[str, list[str]] = {
    ...
    ROLE_ADMIN: [
        ...
        "analytics.view_marketing", "analytics.view_whatsapp", "analytics.view_email",
        "analytics.view_inbox", "analytics.view_team", "analytics.view_automation",
        "analytics.manage",
        "reports.view", "reports.create", "reports.edit", "reports.delete",
        "reports.run", "reports.export", "reports.manage",
    ...
    ROLE_OPERATOR: [
        ...
        "analytics.view", "analytics.view_leads", "analytics.view_scraping",
        "analytics.view_marketing", "analytics.view_whatsapp", "analytics.view_email",
        "analytics.view_inbox", "analytics.view_automation",
        "reports.view", "reports.create", "reports.edit", "reports.delete",
        "reports.run", "reports.export",
        "exports.view", "exports.download",
        "files.view", "files.create", "files.delete",
