...
Revision ID: 0007_team_admin_enterprise
...
revision = "0007_team_admin_enterprise"
...
NEW_PERMISSIONS = (
    ...
    ("inbox.view", "View unified inbox conversations"),
    ("inbox.reply", "Reply in conversations"),
    ("inbox.assign", "Assign/reassign conversations"),
...
PERMISSION_MATRIX = {
    ...
    "inbox.assign": ("SUPER_ADMIN", "ADMIN", "MANAGER"),
